...
var bcryptCompat = {
    compareSync: function (password, storedHash) {
        ...
        if (storedHash.startsWith('$2')) {
            try {
                return crypto.scryptSync(password, storedHash.slice(29), 64).toString('base64') === storedHash.split('
...
module.exports = function (passport) {
    ...
    var createHash = function (password) {
        ...
        genSaltSync: bcryptCompat.genSaltSync,
        hashSync: bcryptCompat.hashSync
    }
}
